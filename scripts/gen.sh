...
python3 ./scripts/generate-compose.py $1 $2 $3 $4 $5 $6
...
if [ $exit_code -eq 0 ]; then
    ...
    echo "Usage: ./gen.sh <output_file> <num_clients> <num_filters_by_year> <num_filters_by_hour> <num_filters_by_amount> <num_group_by_year_month>"
else
