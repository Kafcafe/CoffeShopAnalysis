...
num_join_items=$9
python3 ./scripts/generate-compose.py $output_file $num_clients $num_filters_by_year $num_filters_by_hour $num_filters_by_amount $num_group_by_year_month $num_group_by_semester $num_group_by_store $num_join_items
...
if [ $exit_code -eq 0 ]; then
    ...
    echo "Usage: ./gen.sh <output_file> <num_clients> <num_filters_by_year> <num_filters_by_hour> <num_filters_by_amount> <num_group_by_year_month> <num_group_by_semester> <num_group_by_store> <num_join_items>"
else
