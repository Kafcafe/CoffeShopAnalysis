...
func NewBasicWatchMeshConfig(port int, heartbeatIntervalSeconds, heartbeatTimeoutSeconds float64, addressResolvingRetries int, addressResolvingIntervalSeconds float64) BasicWatchMeshConfig {
